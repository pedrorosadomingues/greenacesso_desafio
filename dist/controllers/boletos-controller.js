...
exports.exibirBoletosOuRelatorio = exports.separarBoletos = exports.postBoletos = void 0;
...
async function exibirBoletosOuRelatorio(req, res) {
    ...
    try {
        const boletosFiltrados = await (0, services_1.exibirBoletosOuRelatorioSvc)({
            nome: nome,
...
exports.exibirBoletosOuRelatorio = exibirBoletosOuRelatorio;
